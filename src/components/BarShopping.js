    ...
    render() {
        ...
        return (
            <div>
                <Navbar>
                    <Ul>
                        <Li><NavLink to="/" className="brand">Shopping Cart</NavLink></Li>
                        
                    </Ul>
                    <Span><NavLink className="NavLink" to="/cart"><i className="fa fa-shopping-cart fa-lg"></i></NavLink><Small>{total}</Small></Span>
